...
var onSignUp = function onSignUp(event) {
  ...
  var data = getFormFields(event.target); // 'data' is when form is filled out
  console.log(data);
...
var onCreateComment = function onCreateComment(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  api.createComment(data).then(ui.createCommentSuccess).catch(ui.createCommentFailure);
};
...
var showComment = function showComment(data) {
  console.log(data);
  return $.ajax({
